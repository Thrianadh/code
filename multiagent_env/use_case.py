...
model = "mistral-large-latest" # Other models available like 'mistral-small-2402'
...
try:
    ...
    response_g2 = client.chat.complete(
        model=model,
        messages=[
...
try:
    response_g3 = client.chat.complete(
        model=model,
        messages=[{"role": "user", "content": prompt_g3}],temperature=0.7,
    )
...
"""
try:
    response_g4 = client.chat.complete(
        model=model,
        messages=[{"role": "user", "content": prompt_g4}],temperature=0.7,
    )
...
"""
try:
    response_g5 = client.chat.complete(
        model=model,
        messages=[{"role": "user", "content": prompt_g5}],temperature=0.7,
    )
...
"""
try:
    response_g6 = client.chat.complete(
        model=model,
        messages=[{"role": "user", "content": prompt_g6}],temperature=0.7,
    )
...
"""
try:
    response_g7 = client.chat.complete(
        model=model,
        messages=[{"role": "user", "content": prompt_g7}],temperature=0.7,
    )
